...
Chat.registerCommand('!паспорт', require('../commands/passport'), '!passport');
Chat.registerCommand('!fate', require('../commands/fate'), '!судьба');
Chat.registerCommand('!суд', require('../commands/court'), '!приговор');
